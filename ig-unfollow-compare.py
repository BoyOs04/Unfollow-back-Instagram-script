...
followers_file = input("Masukkan path file followers (contoh: /storage/emulated/0/ig/f/followers_1.json): ")
following_file = input("Masukkan path file following (contoh: /storage/emulated/0/ig/f/following.json): ")
...
output_dir = input("Masukkan lokasi untuk menyimpan file output (contoh: /storage/emulated/0/ig/output/): ")
